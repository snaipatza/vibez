      ...
      <div className="content no-chat">
        <div className="stage">
          <div className="explore-hero">
            <div>
              <div className="pre">- IIMV Society Radio</div>
          ...
          <div className="rooms-grid">
            <div className="room-card feat" onClick={onJoin}>
              ...
              <h3>{nowPlaying?.title || 'IIMV Society Radio'}</h3>
              <div className="room-sub">
                {(nowPlaying?.dj_username || 'IIMV Society Radio')} / {nowPlaying?.artist || 'Live Station'}
              </div>
